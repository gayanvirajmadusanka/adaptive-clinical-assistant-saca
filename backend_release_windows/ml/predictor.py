...
from backend_release_windows.api.services.audio_service import get_severity_audio
from backend_release_windows.constants import Language, Recommendation, Severity
...
SEVERITY_MAP = {
    ...
    (Recommendation.DOCTOR_CONSULTATION, 0, 1): Severity.SEVERE,
