...
public class BodyPartsData {
    ...
    static {
        PARTS.put("head", new BodyPart("head", "Head", "Jurru", "head_en.wav", "head_wp.wav", Arrays.asList(
        ...
        PARTS.put("eye", new BodyPart("eye", "Eye", "Milpa", "eye_en.wav", "eye_wp.wav", Arrays.asList(
        ...
        PARTS.put("ear", new BodyPart("ear", "Ear", "Langa", "ear_en.wav", "ear_wp.wav", Arrays.asList(
                new BodySymptom("ear_pain", "Pain", "Purrkunypa", "ear_pain_en.wav", "ear_pain_wp.wav"))));

        PARTS.put("nose", new BodyPart("nose", "Nose", "Mulyu", "nose_en.wav", "nose_wp.wav", Arrays.asList(
        ...
        PARTS.put("jaw", new BodyPart("jaw", "Jaw", "Wirlki", "jaw_en.wav", "jaw_wp.wav", Arrays.asList(
                new BodySymptom("jaw_pain", "Pain", "Purrkunypa", "jaw_pain_en.wav", "jaw_pain_wp.wav"))));

        PARTS.put("throat", new BodyPart("throat", "Throat", "Waninja", "throat_en.wav", "throat_wp.wav", Arrays.asList(
                new BodySymptom("sore_throat", "Sore throat", "Waninja kiri", "sore_throat_en.wav", "sore_throat_wp.wav"))));

        PARTS.put("neck", new BodyPart("neck", "Neck", "Nguku", "neck_en.wav", "neck_wp.wav", Arrays.asList(
                new BodySymptom("stiff_neck", "Neck stiffness", "Nguku kantalkantal", "stiff_neck_en.wav", "stiff_neck_wp.wav"))));

        PARTS.put("chest", new BodyPart("chest", "Chest", "Mangarli", "chest_en.wav", "chest_wp.wav", Arrays.asList(
        ...
        PARTS.put("stomach", new BodyPart("stomach", "Stomach", "Miyalu", "stomach_en.wav", "stomach_wp.wav", Arrays.asList(
        ...
        PARTS.put("back", new BodyPart("back", "Back", "Pawiyi", "back_en.wav", "back_wp.wav", Arrays.asList(
                new BodySymptom("back_pain", "Pain", "Purrkunypa", "back_pain_en.wav", "back_pain_wp.wav"))));

        PARTS.put("arm", new BodyPart("arm", "Arm", "Kilpirli", "arm_en.wav", "arm_wp.wav", Arrays.asList(
        ...
        PARTS.put("general", new BodyPart("whole_body", "Whole Body", "Palka", "whole_body_en.wav", "whole_body_wp.wav", Arrays.asList(
