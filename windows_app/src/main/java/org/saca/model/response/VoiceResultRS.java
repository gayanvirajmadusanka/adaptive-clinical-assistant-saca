...
/**
 * Response model for the SACA voice-based symptom detection API endpoint.
 *
 * <p>Returned after the user submits a recorded voice audio for symptom
 * detection. Contains detected symptom lists in both English and Warlpiri,
 * a confidence score, and optional Base64-encoded audio responses for
 * each language.</p>
 *
 ...
 * @see CommonRS
 * @see org.saca.model.request.VoiceInputRQ
 * @see org.saca.controller.VoiceResultController
 */
public class VoiceResultRS extends CommonRS {
    ...
    /**
     * Confidence score of the voice symptom detection result, between 0.0 and 1.0.
     */
    ...
    /**
     * Returns the confidence score of the voice symptom detection result.
     *
    ...
    /**
     * Sets the confidence score of the voice symptom detection result.
     *
     ...
     *
     * @return input type string (e.g. {@code "voice"})
     */
